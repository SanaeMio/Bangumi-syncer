...
class BangumiDataConfig(BaseModel):
    ...
    data_url: str = Field("https://unpkg.com/bangumi-data@0.3/dist/data.json", description="数据URL")
    local_cache_path: str = Field("./bangumi_data_cache.json", description="本地缓存路径")
...
class ConfigData(BaseModel):
    ...
    auth: AuthConfig
    multi_accounts: Dict[str, Dict[str, Any]] = Field(default_factory=dict, description="多账号配置")
