...
class BangumiAuthService:
    ...
    def refresh_primary_token(self, section: Optional[str] = None) -> bool:
    ...
    def refresh_primary_token_if_needed(self, section: Optional[str] = None) -> bool:
    ...
    def _primary_section_name(self) -> Optional[str]:
